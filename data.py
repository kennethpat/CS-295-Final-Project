...
def get_c4(nsamples, seed, seqlen, tokenizer):
    ...
    traindata = load_dataset('../c4/en', data_files={'train': 'c4-train.00000-of-01024.json'}, split='train', cache_dir=".")
    valdata = load_dataset('../c4/en', data_files={'validation': 'c4-validation.00000-of-00008.json'}, split='validation', cache_dir="|.")
